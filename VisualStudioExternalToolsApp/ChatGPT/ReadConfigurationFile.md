...
Using C# read nodes for ExternalTools

- Provided `CurrentSettings.vssettings`
...
create code to write the variable tools to a file named tools.json with indented format
